...
# Make gif
# convert -delay 100 -loop 0 -dispose previous $(find output/tmp/nocountrylines/*.svg | sort) output/nocountrylines_geo-mercator.gif
# convert -delay 100 -loop 0 -dispose previous $(find output/tmp/countrylines/*.svg | sort) output/geo-mercator.gif
# rm -rf output/tmp
